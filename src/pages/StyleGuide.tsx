      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-3xl mb-2">Heading 3</h3>
              <p className="text-sm text-muted-foreground">Font: Merriweather Bold, 1.875rem</p>
            </div>
            <div>
              <h4 className="text-2xl mb-2">Heading 4</h4>
        ...
        {/* Buttons */}
        <section className="mb-16">
          <h2 className="text-3xl mb-8">Buttons</h2>
        ...
        {/* Category Tags */}
        <section className="mb-16">
          <h2 className="text-3xl mb-8">Category Tags</h2>
        ...
        {/* Cards */}
        <section className="mb-16">
          <h2 className="text-3xl mb-8">Cards</h2>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl bg-muted p-6">
              <h3 className="text-xl mb-3">Muted Card</h3>
              <p className="text-muted-foreground">
        ...
        {/* Spacing */}
        <section className="mb-16">
          <h2 className="text-3xl mb-8">Spacing Scale</h2>
        ...
        {/* Border Radius */}
        <section className="mb-16">
          <h2 className="text-3xl mb-8">Border Radius</h2>
