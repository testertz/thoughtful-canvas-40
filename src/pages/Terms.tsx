    ...
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 space-y-4">
          <h1 className="text-4xl md:text-5xl leading-tight animate-slide-down">
            Terms of Service
          </h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl mb-4">Use License</h2>
          ...
          <section>
            <h2 className="text-2xl mb-4">Limitations of Liability</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl mb-4">Links to Other Websites</h2>
            <p className="text-muted-foreground">
